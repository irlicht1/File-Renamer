@echo off
chcp 65001 > nul
title File Renamer v8.0 - Детальная диагностика
color 0A
cls
...
if not exist "renamer_gui_v8.py" (
    echo ❌ ОШИБКА: Файл renamer_gui_v8.py не найден!
    echo.
    echo Убедитесь, что в этой папке есть файл renamer_gui_v8.py
    echo или переименуйте ваш файл в renamer_gui_v8.py
    echo.
    pause
    exit /b 1
)
