...
Графический интерфейс - версия 9.0 с исправлением проблемы заголовка Excel
"""
...
class FileRenamerApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Переименование файлов по таблице v9.0")
    ...
    def create_widgets(self):
        ...
        title_label = ttk.Label(
            self.root, 
            text="📁 Переименование файлов по таблице v9.0",
            style='Title.TLabel'
        )
    ...
    def start_renaming(self):
        ...
        self.log("\n" + "="*70)
        self.log("🚀 НАЧАЛО ПЕРЕИМЕНОВАНИЯ ФАЙЛОВ (Версия 9.0)")
        self.log("="*70)
