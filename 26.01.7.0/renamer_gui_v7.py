...
Графический интерфейс - версия 7.0 с сортировкой по алфавиту
"""
...
class FileRenamerApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Переименование файлов по таблице v7.0")
    ...
    def create_widgets(self):
        ...
        title_label = ttk.Label(
            self.root, 
            text="📁 Переименование файлов по таблице v7.0",
            style='Title.TLabel'
        )
        ...
        info_label = tk.Label(
            ...
            text="📋 ФОРМАТ РАБОТЫ:\n" +
                 ...
                 "3. Второй файл (B) → второе имя из таблицы, и т.д.\n" +
    ...
    def start_renaming(self):
        ...
        confirm = messagebox.askyesno(
            ...
            "2. Первый файл (A) → первое имя из таблицы\n"
            "3. Второй файл (B) → второе имя из таблицы\n"
        ...
        self.log("\n" + "="*70)
        self.log("🚀 НАЧАЛО ПЕРЕИМЕНОВАНИЯ ФАЙЛОВ (Версия 7.0)")
        self.log("="*70)
        ...
        try:
            ...
            # Показываем порядок файлов после сортировки по алфавиту
            self.log("\n📋 ФАЙЛЫ ОТСОРТИРОВАНЫ ПО АЛФАВИТУ:")
            self.log("(A-Z, А-Я, регистронезависимо)")
            ...
            if files_count > names_count:
                ...
                for i in range(names_count, files_count):
                    if i < names_count + 10:  # Показываем только первые 10
                        file_info = file_order[i]
                        self.log(f"  [{i+1:3d}] {file_info['old_name']}")
                if skipped_count > 10:
